...
public class MyApplication {
        ...
        while (true) {
            ...
            try {
                ...
                switch (option) {
                    ...
                    case 7: reserveMenu(); break;
                    case 8: extendMenu(); break;
                    default: return;
                }
    ...
    private void sortMenu() {
        SortBook service = new SortBook();
        service.sort(library);
    ...
    private void reserveMenu() {
        ...
        FindBook find = new FindBook();
        Book book = find.find(library, title);
    ...
    private void extendMenu() {
        ...
        service.extend(member.getBorrowedBooks() > 0);
    }
}
